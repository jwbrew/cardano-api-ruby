...
module SwaggerClient
  ...
  class Account
    ...
    def list_invalid_properties
      ...
      if @index > 4294967295
        invalid_properties.push("invalid value for 'index', must be smaller than or equal to 4294967295.")
      end
    ...
    def valid?
      ...
      return false if @index > 4294967295
    ...
    def index=(index)
      ...
      if index > 4294967295
        fail ArgumentError, "invalid value for 'index', must be smaller than or equal to 4294967295."
      end
    ...
    def hash
      [index, addresses, amount, name, wallet_id].hash
    end
