...
module SwaggerClient
  ...
  class NodeInfo
    ...
    attr_accessor :blockchain_height

    attr_accessor :local_blockchain_height

    attr_accessor :local_time_difference
    ...
    def self.attribute_map
      {
        ...
        :'local_blockchain_height' => :'localBlockchainHeight',
        :'local_time_difference' => :'localTimeDifference'
      }
    end
    ...
    def self.swagger_types
      {
        :'sync_progress' => :'NodeInfoSyncProgress',
        :'blockchain_height' => :'NodeInfoBlockchainHeight',
        :'local_blockchain_height' => :'NodeInfoLocalBlockchainHeight',
        :'local_time_difference' => :'NodeInfoLocalTimeDifference'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'syncProgress')
        self.sync_progress = attributes[:'syncProgress']
      end

      if attributes.has_key?(:'blockchainHeight')
        self.blockchain_height = attributes[:'blockchainHeight']
      end

      if attributes.has_key?(:'localBlockchainHeight')
        self.local_blockchain_height = attributes[:'localBlockchainHeight']
      end

      if attributes.has_key?(:'localTimeDifference')
        self.local_time_difference = attributes[:'localTimeDifference']
      end
    ...
    def list_invalid_properties
      ...
      if @sync_progress.nil?
        invalid_properties.push("invalid value for 'sync_progress', sync_progress cannot be nil.")
      end

      if @local_blockchain_height.nil?
        invalid_properties.push("invalid value for 'local_blockchain_height', local_blockchain_height cannot be nil.")
      end

      if @local_time_difference.nil?
        invalid_properties.push("invalid value for 'local_time_difference', local_time_difference cannot be nil.")
      end
    ...
    def valid?
      return false if @sync_progress.nil?
      return false if @local_blockchain_height.nil?
      return false if @local_time_difference.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          blockchain_height == o.blockchain_height &&
          local_blockchain_height == o.local_blockchain_height &&
          local_time_difference == o.local_time_difference
    end
    ...
    def hash
      [sync_progress, blockchain_height, local_blockchain_height, local_time_difference].hash
    end
