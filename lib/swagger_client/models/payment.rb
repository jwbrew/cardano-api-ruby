...
module SwaggerClient
  ...
  class Payment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'groupingPolicy')
        self.grouping_policy = attributes[:'groupingPolicy']
      end
    ...
    def valid?
      ...
      grouping_policy_validator = EnumAttributeValidator.new('String', ["OptimizeForSecurity", "OptimizeForHighThroughput"])
      return false unless grouping_policy_validator.valid?(@grouping_policy)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] grouping_policy Object to be assigned
    def grouping_policy=(grouping_policy)
      validator = EnumAttributeValidator.new('String', ["OptimizeForSecurity", "OptimizeForHighThroughput"])
      unless validator.valid?(grouping_policy)
        fail ArgumentError, "invalid value for 'grouping_policy', must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          grouping_policy == o.grouping_policy &&
    ...
    def hash
      [source, destinations, grouping_policy, spending_password].hash
    end
