...
module SwaggerClient
  ...
  class PaginationMetadata
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'totalEntries')
        self.total_entries = attributes[:'totalEntries']
      end
    ...
    def list_invalid_properties
      ...
      if @total_pages > 9223372036854775807
        invalid_properties.push("invalid value for 'total_pages', must be smaller than or equal to 9223372036854775807.")
      end
      ...
      if @total_entries > 9223372036854775807
        invalid_properties.push("invalid value for 'total_entries', must be smaller than or equal to 9223372036854775807.")
      end

      if @total_entries < 0
        invalid_properties.push("invalid value for 'total_entries', must be greater than or equal to 0.")
      end
    ...
    def valid?
      ...
      return false if @total_pages > 9223372036854775807
      return false if @total_pages < 0
      return false if @page.nil?
      return false if @per_page.nil?
      return false if @total_entries.nil?
      return false if @total_entries > 9223372036854775807
    ...
    def total_pages=(total_pages)
      ...
      if total_pages > 9223372036854775807
        fail ArgumentError, "invalid value for 'total_pages', must be smaller than or equal to 9223372036854775807."
      end
    ...
    def total_entries=(total_entries)
      ...
      if total_entries > 9223372036854775807
        fail ArgumentError, "invalid value for 'total_entries', must be smaller than or equal to 9223372036854775807."
      end

      if total_entries < 0
        fail ArgumentError, "invalid value for 'total_entries', must be greater than or equal to 0."
      end
    ...
    def hash
      [total_pages, page, per_page, total_entries].hash
    end
