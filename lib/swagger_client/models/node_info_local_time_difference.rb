...
module SwaggerClient
  # Local time difference, in number of blocks
  class NodeInfoLocalTimeDifference
    ...
    def valid?
      ...
      unit_validator = EnumAttributeValidator.new('String', ["microseconds"])
    ...
    def unit=(unit)
      validator = EnumAttributeValidator.new('String', ["microseconds"])
