...
module SwaggerClient
  ...
  class NodeInfoSyncProgress
    ...
    def valid?
      ...
      unit_validator = EnumAttributeValidator.new('String', ["percent"])
    ...
    def quantity=(quantity)
      ...
      if quantity > 100
        fail ArgumentError, "invalid value for 'quantity', must be smaller than or equal to 100."
      end
