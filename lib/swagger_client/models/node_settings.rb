...
module SwaggerClient
  ...
  class NodeSettings
    ...
    def self.swagger_types
      {
        :'slot_duration' => :'NodeSettingsSlotDuration',
        :'software_info' => :'NodeSettingsSoftwareInfo',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'slotDuration')
        self.slot_duration = attributes[:'slotDuration']
      end

      if attributes.has_key?(:'softwareInfo')
        self.software_info = attributes[:'softwareInfo']
      end

      if attributes.has_key?(:'projectVersion')
        self.project_version = attributes[:'projectVersion']
      end

      if attributes.has_key?(:'gitRevision')
        self.git_revision = attributes[:'gitRevision']
      end
    ...
    def list_invalid_properties
      ...
      if @slot_duration.nil?
        invalid_properties.push("invalid value for 'slot_duration', slot_duration cannot be nil.")
      end

      if @software_info.nil?
        invalid_properties.push("invalid value for 'software_info', software_info cannot be nil.")
      end

      if @project_version.nil?
        invalid_properties.push("invalid value for 'project_version', project_version cannot be nil.")
      end

      if @git_revision.nil?
        invalid_properties.push("invalid value for 'git_revision', git_revision cannot be nil.")
      end
    ...
    def valid?
      return false if @slot_duration.nil?
      return false if @software_info.nil?
      return false if @project_version.nil?
      return false if @git_revision.nil?
      return true
    end
    ...
    def hash
      [slot_duration, software_info, project_version, git_revision].hash
    end
