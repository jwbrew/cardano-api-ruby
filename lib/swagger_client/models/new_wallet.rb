...
module SwaggerClient
  ...
  class NewWallet
    ...
    attr_accessor :backup_phrase

    # Optional spending password to encrypt / decrypt private keys
    attr_accessor :spending_password
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'backupPhrase')
        if (value = attributes[:'backupPhrase']).is_a?(Array)
          self.backup_phrase = value
        end
      end

      if attributes.has_key?(:'spendingPassword')
        self.spending_password = attributes[:'spendingPassword']
      end
    ...
    def list_invalid_properties
      ...
      if @backup_phrase.nil?
        invalid_properties.push("invalid value for 'backup_phrase', backup_phrase cannot be nil.")
      end

      if @assurance_level.nil?
        invalid_properties.push("invalid value for 'assurance_level', assurance_level cannot be nil.")
      end
    ...
    def valid?
      return false if @backup_phrase.nil?
      return false if @assurance_level.nil?
      assurance_level_validator = EnumAttributeValidator.new('String', ["normal", "strict"])
      return false unless assurance_level_validator.valid?(@assurance_level)
      return false if @name.nil?
      return false if @operation.nil?
      operation_validator = EnumAttributeValidator.new('String', ["create", "restore"])
      return false unless operation_validator.valid?(@operation)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] assurance_level Object to be assigned
    def assurance_level=(assurance_level)
      validator = EnumAttributeValidator.new('String', ["normal", "strict"])
      unless validator.valid?(assurance_level)
        fail ArgumentError, "invalid value for 'assurance_level', must be one of #{validator.allowable_values}."
      end
    ...
    def operation=(operation)
      validator = EnumAttributeValidator.new('String', ["create", "restore"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          backup_phrase == o.backup_phrase &&
          spending_password == o.spending_password &&
    ...
    def hash
      [backup_phrase, spending_password, assurance_level, name, operation].hash
    end
