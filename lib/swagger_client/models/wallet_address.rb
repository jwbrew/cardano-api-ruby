...
module SwaggerClient
  ...
  class WalletAddress
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'changeAddress')
        self.change_address = attributes[:'changeAddress']
      end
    ...
    def list_invalid_properties
      ...
      if @balance > 45000000000000000
        invalid_properties.push("invalid value for 'balance', must be smaller than or equal to 45000000000000000.")
      end
    ...
    def valid?
      ...
      return false if @balance > 45000000000000000
    ...
    def balance=(balance)
      ...
      if balance > 45000000000000000
        fail ArgumentError, "invalid value for 'balance', must be smaller than or equal to 45000000000000000."
      end
    ...
    def hash
      [id, balance, used, change_address].hash
    end
