...
module SwaggerClient
  ...
  class NewAddress
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accountIndex')
        self.account_index = attributes[:'accountIndex']
      end
    ...
    def list_invalid_properties
      ...
      if @account_index.nil?
        invalid_properties.push("invalid value for 'account_index', account_index cannot be nil.")
      end

      if @account_index > 4294967295
        invalid_properties.push("invalid value for 'account_index', must be smaller than or equal to 4294967295.")
      end

      if @account_index < 0
        invalid_properties.push("invalid value for 'account_index', must be greater than or equal to 0.")
      end
    ...
    def valid?
      return false if @account_index.nil?
      return false if @account_index > 4294967295
      return false if @account_index < 0
      return false if @wallet_id.nil?
      return true
    end

    # Custom attribute writer method with validation
    # @param [Object] account_index Value to be assigned
    def account_index=(account_index)
      if account_index.nil?
        fail ArgumentError, "account_index cannot be nil"
      end

      if account_index > 4294967295
        fail ArgumentError, "invalid value for 'account_index', must be smaller than or equal to 4294967295."
      end

      if account_index < 0
        fail ArgumentError, "invalid value for 'account_index', must be greater than or equal to 0."
      end
    ...
    def hash
      [spending_password, account_index, wallet_id].hash
    end
