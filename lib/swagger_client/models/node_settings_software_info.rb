...
module SwaggerClient
  ...
  class NodeSettingsSoftwareInfo
    ...
    def list_invalid_properties
      ...
      if @version > 4294967295
        invalid_properties.push("invalid value for 'version', must be smaller than or equal to 4294967295.")
      end
    ...
    def valid?
      ...
      return false if @version > 4294967295
    ...
    def version=(version)
      ...
      if version > 4294967295
        fail ArgumentError, "invalid value for 'version', must be smaller than or equal to 4294967295."
      end
