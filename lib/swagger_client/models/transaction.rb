...
module SwaggerClient
  ...
  class Transaction
    ...
    def list_invalid_properties
      ...
      if @confirmations > -1
        invalid_properties.push("invalid value for 'confirmations', must be smaller than or equal to -1.")
      end

      if @confirmations < 0
        invalid_properties.push("invalid value for 'confirmations', must be greater than or equal to 0.")
      end
      ...
      if @amount > 45000000000000000
        invalid_properties.push("invalid value for 'amount', must be smaller than or equal to 45000000000000000.")
      end
    ...
    def valid?
      ...
      return false if @confirmations > -1
      return false if @confirmations < 0
      return false if @amount.nil?
      return false if @amount > 45000000000000000
      return false if @inputs.nil?
      return false if @outputs.nil?
      return false if @type.nil?
      type_validator = EnumAttributeValidator.new('String', ["local", "foreign"])
      return false unless type_validator.valid?(@type)
      return false if @direction.nil?
      direction_validator = EnumAttributeValidator.new('String', ["outgoing", "incoming"])
      return false unless direction_validator.valid?(@direction)
      return true
    end

    # Custom attribute writer method with validation
    # @param [Object] confirmations Value to be assigned
    def confirmations=(confirmations)
      if confirmations.nil?
        fail ArgumentError, "confirmations cannot be nil"
      end

      if confirmations > -1
        fail ArgumentError, "invalid value for 'confirmations', must be smaller than or equal to -1."
      end

      if confirmations < 0
        fail ArgumentError, "invalid value for 'confirmations', must be greater than or equal to 0."
      end
    ...
    def amount=(amount)
      ...
      if amount > 45000000000000000
        fail ArgumentError, "invalid value for 'amount', must be smaller than or equal to 45000000000000000."
      end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["local", "foreign"])
    ...
    def hash
      [id, confirmations, amount, inputs, outputs, type, direction].hash
    end
