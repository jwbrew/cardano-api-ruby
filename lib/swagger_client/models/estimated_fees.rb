...
module SwaggerClient
  ...
  class EstimatedFees
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'estimatedAmount')
        self.estimated_amount = attributes[:'estimatedAmount']
      end
    ...
    def list_invalid_properties
      ...
      if @estimated_amount.nil?
        invalid_properties.push("invalid value for 'estimated_amount', estimated_amount cannot be nil.")
      end

      if @estimated_amount > 45000000000000000
        invalid_properties.push("invalid value for 'estimated_amount', must be smaller than or equal to 45000000000000000.")
      end
    ...
    def valid?
      return false if @estimated_amount.nil?
      return false if @estimated_amount > 45000000000000000
      return true
    end

    # Custom attribute writer method with validation
    # @param [Object] estimated_amount Value to be assigned
    def estimated_amount=(estimated_amount)
      if estimated_amount.nil?
        fail ArgumentError, "estimated_amount cannot be nil"
      end

      if estimated_amount > 45000000000000000
        fail ArgumentError, "invalid value for 'estimated_amount', must be smaller than or equal to 45000000000000000."
      end
