...
module SwaggerClient
  class TransactionsApi
    ...
    # @return [WalletResponseEstimatedFees]
    def api_v1_transactions_fees_post(body, opts = {})
      data, _status_code, _headers = api_v1_transactions_fees_post_with_http_info(body, opts)
      return data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WalletResponseEstimatedFees, Fixnum, Hash)>] WalletResponseEstimatedFees data, response status code and response headers
    def api_v1_transactions_fees_post_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TransactionsApi.api_v1_transactions_fees_post ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling TransactionsApi.api_v1_transactions_fees_post"
      end
      # resource path
      local_var_path = "/api/v1/transactions/fees"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'WalletResponseEstimatedFees')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransactionsApi#api_v1_transactions_fees_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [WalletResponseTransaction]
    def api_v1_transactions_post(body, opts = {})
      data, _status_code, _headers = api_v1_transactions_post_with_http_info(body, opts)
      return data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WalletResponseTransaction, Fixnum, Hash)>] WalletResponseTransaction data, response status code and response headers
    def api_v1_transactions_post_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TransactionsApi.api_v1_transactions_post ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling TransactionsApi.api_v1_transactions_post"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'WalletResponseTransaction')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransactionsApi#api_v1_transactions_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param wallet_id 
    # @param [Hash] opts the optional parameters
    # @option opts [Integer] :account_index 
    ...
    # @return [WalletResponseTransaction]
    def api_v1_transactions_wallet_id_get(wallet_id, opts = {})
      data, _status_code, _headers = api_v1_transactions_wallet_id_get_with_http_info(wallet_id, opts)
      return data
    end
    ...
    # @return [Array<(WalletResponseTransaction, Fixnum, Hash)>] WalletResponseTransaction data, response status code and response headers
    def api_v1_transactions_wallet_id_get_with_http_info(wallet_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: TransactionsApi.api_v1_transactions_wallet_id_get ..."
      end
      # verify the required parameter 'wallet_id' is set
      if @api_client.config.client_side_validation && wallet_id.nil?
        fail ArgumentError, "Missing the required parameter 'wallet_id' when calling TransactionsApi.api_v1_transactions_wallet_id_get"
      end
      if @api_client.config.client_side_validation && !opts[:'account_index'].nil? && opts[:'account_index'] > 4294967295
        fail ArgumentError, 'invalid value for "opts[:"account_index"]" when calling TransactionsApi.api_v1_transactions_wallet_id_get, must be smaller than or equal to 4294967295.'
      end

      if @api_client.config.client_side_validation && !opts[:'account_index'].nil? && opts[:'account_index'] < 0
        fail ArgumentError, 'invalid value for "opts[:"account_index"]" when calling TransactionsApi.api_v1_transactions_wallet_id_get, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'page'].nil? && opts[:'page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"page"]" when calling TransactionsApi.api_v1_transactions_wallet_id_get, must be greater than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 50
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling TransactionsApi.api_v1_transactions_wallet_id_get, must be smaller than or equal to 50.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling TransactionsApi.api_v1_transactions_wallet_id_get, must be greater than or equal to 1.'
      end

      # resource path
      local_var_path = "/api/v1/transactions/{walletId}".sub('{' + 'walletId' + '}', wallet_id.to_s)

      # query parameters
      query_params = {}
      query_params[:'account_index'] = opts[:'account_index'] if !opts[:'account_index'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'WalletResponseTransaction')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransactionsApi#api_v1_transactions_wallet_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
