...
module SwaggerClient
  class AddressesApi
    ...
    # @return [WalletResponseAddressValidity]
    def api_v1_addresses_address_validity_get(address, opts = {})
      data, _status_code, _headers = api_v1_addresses_address_validity_get_with_http_info(address, opts)
      return data
    end
    ...
    # @param address 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WalletResponseAddressValidity, Fixnum, Hash)>] WalletResponseAddressValidity data, response status code and response headers
    def api_v1_addresses_address_validity_get_with_http_info(address, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AddressesApi.api_v1_addresses_address_validity_get ..."
      end
      # verify the required parameter 'address' is set
      if @api_client.config.client_side_validation && address.nil?
        fail ArgumentError, "Missing the required parameter 'address' when calling AddressesApi.api_v1_addresses_address_validity_get"
      end
      # resource path
      local_var_path = "/api/v1/addresses/{address}/validity".sub('{' + 'address' + '}', address.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'WalletResponseAddressValidity')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AddressesApi#api_v1_addresses_address_validity_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [WalletResponseAddress]
    def api_v1_addresses_get(opts = {})
      data, _status_code, _headers = api_v1_addresses_get_with_http_info(opts)
      return data
    end
    ...
    # @return [Array<(WalletResponseAddress, Fixnum, Hash)>] WalletResponseAddress data, response status code and response headers
    def api_v1_addresses_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AddressesApi.api_v1_addresses_get ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page'].nil? && opts[:'page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"page"]" when calling AddressesApi.api_v1_addresses_get, must be greater than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 50
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling AddressesApi.api_v1_addresses_get, must be smaller than or equal to 50.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling AddressesApi.api_v1_addresses_get, must be greater than or equal to 1.'
      end

      # resource path
      local_var_path = "/api/v1/addresses"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'WalletResponseAddress')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AddressesApi#api_v1_addresses_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [WalletResponseWalletAddress]
    def api_v1_addresses_post(body, opts = {})
      data, _status_code, _headers = api_v1_addresses_post_with_http_info(body, opts)
      return data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WalletResponseWalletAddress, Fixnum, Hash)>] WalletResponseWalletAddress data, response status code and response headers
    def api_v1_addresses_post_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AddressesApi.api_v1_addresses_post ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AddressesApi.api_v1_addresses_post"
      end
      # resource path
      local_var_path = "/api/v1/addresses"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'WalletResponseWalletAddress')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AddressesApi#api_v1_addresses_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
