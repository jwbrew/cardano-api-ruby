...
module SwaggerClient
  class AccountsApi
    ...
    # @return [nil]
    def api_v1_wallets_wallet_id_accounts_account_index_delete(wallet_id, account_index, opts = {})
      api_v1_wallets_wallet_id_accounts_account_index_delete_with_http_info(wallet_id, account_index, opts)
      return nil
    end
    ...
    def api_v1_wallets_wallet_id_accounts_account_index_delete_with_http_info(wallet_id, account_index, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_delete ..."
      end
      # verify the required parameter 'wallet_id' is set
      if @api_client.config.client_side_validation && wallet_id.nil?
        fail ArgumentError, "Missing the required parameter 'wallet_id' when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_delete"
      end
      # verify the required parameter 'account_index' is set
      if @api_client.config.client_side_validation && account_index.nil?
        fail ArgumentError, "Missing the required parameter 'account_index' when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_delete"
      end
      if @api_client.config.client_side_validation && account_index > 4294967295
        fail ArgumentError, 'invalid value for "account_index" when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_delete, must be smaller than or equal to 4294967295.'
      end

      if @api_client.config.client_side_validation && account_index < 0
        fail ArgumentError, 'invalid value for "account_index" when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_delete, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = "/api/v1/wallets/{walletId}/accounts/{accountIndex}".sub('{' + 'walletId' + '}', wallet_id.to_s).sub('{' + 'accountIndex' + '}', account_index.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#api_v1_wallets_wallet_id_accounts_account_index_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param account_index 
    # @param [Hash] opts the optional parameters
    # @return [WalletResponseAccount]
    def api_v1_wallets_wallet_id_accounts_account_index_get(wallet_id, account_index, opts = {})
      data, _status_code, _headers = api_v1_wallets_wallet_id_accounts_account_index_get_with_http_info(wallet_id, account_index, opts)
      return data
    end
    ...
    # @param account_index 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WalletResponseAccount, Fixnum, Hash)>] WalletResponseAccount data, response status code and response headers
    def api_v1_wallets_wallet_id_accounts_account_index_get_with_http_info(wallet_id, account_index, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_get ..."
      end
      # verify the required parameter 'wallet_id' is set
      if @api_client.config.client_side_validation && wallet_id.nil?
        fail ArgumentError, "Missing the required parameter 'wallet_id' when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_get"
      end
      # verify the required parameter 'account_index' is set
      if @api_client.config.client_side_validation && account_index.nil?
        fail ArgumentError, "Missing the required parameter 'account_index' when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_get"
      end
      if @api_client.config.client_side_validation && account_index > 4294967295
        fail ArgumentError, 'invalid value for "account_index" when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_get, must be smaller than or equal to 4294967295.'
      end

      if @api_client.config.client_side_validation && account_index < 0
        fail ArgumentError, 'invalid value for "account_index" when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_get, must be greater than or equal to 0.'
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'WalletResponseAccount')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#api_v1_wallets_wallet_id_accounts_account_index_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [WalletResponseAccount]
    def api_v1_wallets_wallet_id_accounts_account_index_put(wallet_id, account_index, body, opts = {})
      data, _status_code, _headers = api_v1_wallets_wallet_id_accounts_account_index_put_with_http_info(wallet_id, account_index, body, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WalletResponseAccount, Fixnum, Hash)>] WalletResponseAccount data, response status code and response headers
    def api_v1_wallets_wallet_id_accounts_account_index_put_with_http_info(wallet_id, account_index, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_put ..."
      end
      # verify the required parameter 'wallet_id' is set
      if @api_client.config.client_side_validation && wallet_id.nil?
        fail ArgumentError, "Missing the required parameter 'wallet_id' when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_put"
      end
      # verify the required parameter 'account_index' is set
      if @api_client.config.client_side_validation && account_index.nil?
        fail ArgumentError, "Missing the required parameter 'account_index' when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_put"
      end
      if @api_client.config.client_side_validation && account_index > 4294967295
        fail ArgumentError, 'invalid value for "account_index" when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_put, must be smaller than or equal to 4294967295.'
      end

      if @api_client.config.client_side_validation && account_index < 0
        fail ArgumentError, 'invalid value for "account_index" when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_put, must be greater than or equal to 0.'
      end

      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AccountsApi.api_v1_wallets_wallet_id_accounts_account_index_put"
      end
      # resource path
      local_var_path = "/api/v1/wallets/{walletId}/accounts/{accountIndex}".sub('{' + 'walletId' + '}', wallet_id.to_s).sub('{' + 'accountIndex' + '}', account_index.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'WalletResponseAccount')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#api_v1_wallets_wallet_id_accounts_account_index_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [WalletResponseAccount]
    def api_v1_wallets_wallet_id_accounts_get(wallet_id, opts = {})
      data, _status_code, _headers = api_v1_wallets_wallet_id_accounts_get_with_http_info(wallet_id, opts)
      return data
    end
    ...
    # @return [Array<(WalletResponseAccount, Fixnum, Hash)>] WalletResponseAccount data, response status code and response headers
    def api_v1_wallets_wallet_id_accounts_get_with_http_info(wallet_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.api_v1_wallets_wallet_id_accounts_get ..."
      end
      # verify the required parameter 'wallet_id' is set
      if @api_client.config.client_side_validation && wallet_id.nil?
        fail ArgumentError, "Missing the required parameter 'wallet_id' when calling AccountsApi.api_v1_wallets_wallet_id_accounts_get"
      end
      if @api_client.config.client_side_validation && !opts[:'page'].nil? && opts[:'page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"page"]" when calling AccountsApi.api_v1_wallets_wallet_id_accounts_get, must be greater than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 50
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling AccountsApi.api_v1_wallets_wallet_id_accounts_get, must be smaller than or equal to 50.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling AccountsApi.api_v1_wallets_wallet_id_accounts_get, must be greater than or equal to 1.'
      end

      # resource path
      local_var_path = "/api/v1/wallets/{walletId}/accounts".sub('{' + 'walletId' + '}', wallet_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'WalletResponseAccount')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#api_v1_wallets_wallet_id_accounts_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [WalletResponseAccount]
    def api_v1_wallets_wallet_id_accounts_post(wallet_id, body, opts = {})
      data, _status_code, _headers = api_v1_wallets_wallet_id_accounts_post_with_http_info(wallet_id, body, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WalletResponseAccount, Fixnum, Hash)>] WalletResponseAccount data, response status code and response headers
    def api_v1_wallets_wallet_id_accounts_post_with_http_info(wallet_id, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AccountsApi.api_v1_wallets_wallet_id_accounts_post ..."
      end
      # verify the required parameter 'wallet_id' is set
      if @api_client.config.client_side_validation && wallet_id.nil?
        fail ArgumentError, "Missing the required parameter 'wallet_id' when calling AccountsApi.api_v1_wallets_wallet_id_accounts_post"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AccountsApi.api_v1_wallets_wallet_id_accounts_post"
      end
      # resource path
      local_var_path = "/api/v1/wallets/{walletId}/accounts".sub('{' + 'walletId' + '}', wallet_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'WalletResponseAccount')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountsApi#api_v1_wallets_wallet_id_accounts_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
