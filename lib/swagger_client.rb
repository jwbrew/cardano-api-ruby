...
require 'swagger_client/models/address_validity'
require 'swagger_client/models/assurance_level'
require 'swagger_client/models/blockchain_height'
require 'swagger_client/models/estimated_fees'
require 'swagger_client/models/local_time_difference'
require 'swagger_client/models/metadata'
...
require 'swagger_client/models/node_info_blockchain_height'
require 'swagger_client/models/node_info_local_blockchain_height'
require 'swagger_client/models/node_info_local_time_difference'
require 'swagger_client/models/node_info_sync_progress'
require 'swagger_client/models/node_settings'
require 'swagger_client/models/node_settings_slot_duration'
require 'swagger_client/models/node_settings_software_info'
require 'swagger_client/models/page'
require 'swagger_client/models/pagination_metadata'
require 'swagger_client/models/password_update'
require 'swagger_client/models/payment'
require 'swagger_client/models/payment_distribution'
require 'swagger_client/models/payment_source'
require 'swagger_client/models/per_page'
require 'swagger_client/models/response_status'
require 'swagger_client/models/slot_duration'
require 'swagger_client/models/sync_progress'
require 'swagger_client/models/transaction'
require 'swagger_client/models/transaction_direction'
require 'swagger_client/models/transaction_type'
require 'swagger_client/models/v1_address'
require 'swagger_client/models/v1_backup_phrase'
require 'swagger_client/models/v1_coin'
require 'swagger_client/models/v1_input_selection_policy'
require 'swagger_client/models/v1_pass_phrase'
require 'swagger_client/models/v1_software_version'
require 'swagger_client/models/version'
require 'swagger_client/models/wallet'
require 'swagger_client/models/wallet_address'
require 'swagger_client/models/wallet_id'
require 'swagger_client/models/wallet_operation'
require 'swagger_client/models/wallet_response_account'
require 'swagger_client/models/wallet_response_address'
require 'swagger_client/models/wallet_response_address_validity'
require 'swagger_client/models/wallet_response_estimated_fees'
require 'swagger_client/models/wallet_response_node_info'
require 'swagger_client/models/wallet_response_node_settings'
require 'swagger_client/models/wallet_response_transaction'
require 'swagger_client/models/wallet_response_wallet'
require 'swagger_client/models/wallet_response_wallet_address'
require 'swagger_client/models/wallet_update'

# APIs
require 'swagger_client/api/accounts_api'
require 'swagger_client/api/addresses_api'
require 'swagger_client/api/info_api'
