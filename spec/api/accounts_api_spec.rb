...
describe 'AccountsApi' do
  ...
  # unit tests for api_v1_wallets_wallet_id_accounts_account_index_delete
  # Deletes an Account.
  # 
  # @param wallet_id 
  # @param account_index 
  ...
  # @return [nil]
  describe 'api_v1_wallets_wallet_id_accounts_account_index_delete test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_v1_wallets_wallet_id_accounts_account_index_get
  ...
  describe 'api_v1_wallets_wallet_id_accounts_account_index_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_v1_wallets_wallet_id_accounts_account_index_put
  ...
  # @param [Hash] opts the optional parameters
  # @return [WalletResponseAccount]
  describe 'api_v1_wallets_wallet_id_accounts_account_index_put test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_v1_wallets_wallet_id_accounts_get
  ...
  # @return [WalletResponseAccount]
  describe 'api_v1_wallets_wallet_id_accounts_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_v1_wallets_wallet_id_accounts_post
  ...
  # @param [Hash] opts the optional parameters
  # @return [WalletResponseAccount]
  describe 'api_v1_wallets_wallet_id_accounts_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
