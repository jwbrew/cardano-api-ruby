...
describe 'WalletsApi' do
  ...
  # unit tests for api_v1_wallets_get
  ...
  describe 'api_v1_wallets_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_v1_wallets_post
  # Creates a new or restores an existing Wallet.
  # 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [WalletResponseWallet]
  describe 'api_v1_wallets_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_v1_wallets_wallet_id_delete
  # Deletes the given Wallet and all its accounts.
  # 
  # @param wallet_id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'api_v1_wallets_wallet_id_delete test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_v1_wallets_wallet_id_get
  # Returns the Wallet identified by the given walletId.
  # 
  # @param wallet_id 
  # @param [Hash] opts the optional parameters
  # @return [WalletResponseWallet]
  describe 'api_v1_wallets_wallet_id_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_v1_wallets_wallet_id_password_put
  ...
  # @param [Hash] opts the optional parameters
  # @return [WalletResponseWallet]
  describe 'api_v1_wallets_wallet_id_password_put test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_v1_wallets_wallet_id_put
  ...
  # @param [Hash] opts the optional parameters
  # @return [WalletResponseWallet]
  describe 'api_v1_wallets_wallet_id_put test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
